...
![Displaying the currency value in UWP SfDataGrid](../../images/Column-Types_img1.png)
...
![Displaying the column with progressBar in UWP SfDataGrid](../../images/Column-Types_img2.png)
...
![Displaying the column with CellTemplate in UWP SfDataGrid](../../images/Column-Types_img3.png)
...
![Displaying the column with CellTemplateSelector in UWP SfDataGrid](../../images/Column-Types_img4.png)
...
![Displaying column  formatting with converter in UWP SfDataGrid](../../images/Column-Types_img5.png)
...
![Applying cell style to the columns in UWP SfDataGrid](../../images/Column-Types_img6.png)
...
![Applying cell style to the columns by using CellStyleSelector in UWP SfDataGrid]](../../images/Column-Types_img7.png)
...
![Applying TextTrimming,TextDecorations,TextAlignment,TextWrapping to columns in UWP SfDataGrid](../../images/Column-Types_img8.png)
...
![Image used to display the spell check in SfDataGrid UWP](../../images/Column-Types_img9.png)
...
![Displaying numeric column in UWP SfDataGrid](../../images/Column-Types_img10.png)
...
![Displaying data formatting of numeric column in UWP SfDataGrid](../../images/Column-Types_img11.png)
...
![Displaying WaterMark text of numeric column in UWP SfDataGrid](../../images/Column-Types_img12.png)
...
![Displaying GridDateTimeColumn with SfDatePicker in UWP SfDataGrid](../../images/Column-Types_img13.png)
...
![Displaying data formatting in GridDateTimeColumn with SfDatePicker in UWP SfDataGrid](../../images/Column-Types_img14.png)
...
![Displaying custom date-time formatting in GridDateTimeColumn in UWP SfDataGrid](../../images/Column-Types_img15.png)
...
![Displaying editing in GridDateTimeColumn with On-Screen keyboard in Desktop view of UWP SfDataGrid](../../images/Column-Types_img16.png)


![Displaying editing in GridDateTimeColumn with On-Screen keyboard in Mobile view of UWP SfDataGrid](../../images/Column-Types_img17.png)
...
![Displaying null value in GridDateTimeColumn in UWP SfDataGrid](../../images/Column-Types_img18.png)
...
![Displaying customization of drop-down button in GridDateTimeColumn in UWP SfDataGrid](../../images/Column-Types_img19.png)
...
![Styling SelectorItem with color in GridDateTimeColumn in UWP SfDataGrid](../../images/Column-Types_img20.png)
...
![Displaying height and width customization of SelectorItem in GridDateTimeColumn in UWP SfDataGrid](../../images/Column-Types_img21.png)
...
![Displaying custom formatting of SelectorItem in GridDateTimeColumn in UWP SfDataGrid](../../images/Column-Types_img22.png)
...
![Displaying space and count customization between SelectorItems in GridDateTimeColumn in UWP SfDataGrid](../../images/Column-Types_img23.png)
...
![Displaying GridCheckBoxColumn in UWP SfDataGrid](../../images/Column-Types_img24.png)
...
![Displaying CellTemplateSelector and EditTemplateSelector with GridTemplateColumn in UWP SfDataGrid](../../images/Column-Types_img25.png)
...
![Displaying GridComboBoxColumn with SelectedItem in UWP SfDataGrid](../../images/Column-Types_img26.png)
...
![Displaying different itemssource for different rows using ItemsSourceSelector property of GridComboBoxColumn in UWP SfDataGrid](../../images/Column-Types_img37.png)

![Displaying different itemssource for different rows using ItemsSourceSelector property of GridComboBoxColumn in UWP SfDataGrid](../../images/Column-Types_img38.png)
...
![Image used to display GridMultiColumnDropDownList in SfDataGrid UWP](../../images/Column-Types_img27.png)
...
![Displaying GridMultiColumnDropDownList with filtered items in UWP SfDataGrid](../../images/Column-Types_img28.png)
...
![Displaying GridMultiColumnDropDownList with resizing enabled in UWP SfDataGrid](../../images/Column-Types_img29.png)
...
![Displaying different itemssource for different rows using the ItemsSourceSelector property of GridMultiColumnDropDownList in UWP SfDataGrid](../../images/Column-Types_img39.png)

![Displaying different itemssource for different rows using the ItemsSourceSelector property of GridMultiColumnDropDownList in UWP SfDataGrid](../../images/Column-Types_img40.png)
...
![Displaying GridHyperlinkColumn in UWP SfDataGrid](../../images/Column-Types_img30.png)
...
![Displaying GridImageColumn in UWP SfDataGrid](../../images/Column-Types_img31.png)
...
![Displaying GridUpDownColumn in UWP SfDataGrid](../../images/Column-Types_img32.png)
...
![Displaying GridToggleSwitchColumn in UWP SfDataGrid](../../images/Column-Types_img36.png)
...
![uwp datagrid selector column](../../images/Column-Types_img41.png)
...
![uwp datagrid selector column with text in column header](../../images/Column-Types_img42.png)
...
![uwp datagrid selector column with styled checkbox in both record cells and header](../../images/Column-Types_img43.png)
...
![Displaying foreground customization of column by customizing the renderer in UWP SfDataGrid](../../images/Column-Types_img33.png)
...
![Displaying custom column created from existing renderer in UWP SfDataGrid](../../images/Column-Types_img34.png)
...
![Displaying custom TimePickerColumn in UWP SfDataGrid](../../images/Column-Types_img35.png)
