...
<td>
<img src="../../images/Filtering_img6.png" />
</td>
<td>
<img src="../../images/Filtering_img7.png" />
</td>
</tr>
<tr>
<td>
...
![Improve the performance while applying the filter in SfDataGrid UWP](../../images/Filtering_img8.png)
...
![Filter the NULL values by using the CheckBox Filter view in SfDataGrid UWP](../../images/Filtering_img9.png)

#### Advanced Filter with AllowBlankFilters as True

![Filter the NULL values by using the Advanced Filter view in SfDataGrid UWP](../../images/Filtering_img10.png    )
...
![Apply the immediate filter in CheckBox Filter view in DataGrid UWP](../../images/Filtering_img11.png)

#### Advanced Filter with ImmediateUpdateColumnFilter is True

![Apply the immediate filter in Advanced Filter view in DataGrid UWP](../../images/Filtering_img12.png)
...
![Apply the filter based on the underlying value in DataGrid UWP](../../images/Filtering_img13.png)
...
![Apply the filter based on the display text in DataGrid UWP](../../images/Filtering_img14.png)
...
![Apply the filter based on the actual value in DataGrid UWP](../../images/Filtering_img15.png)

After filtering, both records having the same OrderDate display value will be displayed in view.

![Filter the same values records in DataGrid UWP](../../images/Filtering_img16.png)
...
![Apply the column filter for image in DataGrid UWP](../../images/Filtering_img18.png)
...
![Hide the SortOptions from Filter popup in DataGrid UWP](../../images/Filtering_img17.png)
...
![Customize the FilterPopup in DataGrid UWP](../../images/Filtering_img19.png)
